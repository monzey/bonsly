...
## Type: Dict
# c.aliases = {'w': 'session-save', 'wq': 'quit --save', 'q': 'quit'}
...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-[>': '<Escape>', '<Ctrl-M>': '<Return>', '<Shift-Return>': '<Return>', '<Shift-Enter>': '<Return>', '<Ctrl-J>': '<Return>', '<Enter>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-6>': '<Ctrl-^>'}
...
## Type: String
c.colors.prompts.border = '1px solid #333333'
...
## Type: QssColor
c.colors.prompts.selected.bg = '#333333'
...
## Type: QssColor
c.colors.statusbar.command.private.bg = '#2c043e'
...
## Type: QssColor
c.colors.statusbar.private.bg = '#500074'
...
## Type: List of Url
c.content.host_blocking.lists = ['https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts', str(config.configdir) + "/blockedHosts"]
...
## Type: Dict
# c.content.javascript.log = {'warning': 'debug', 'unknown': 'debug', 'error': 'debug', 'info': 'debug'}
...
## Type: Font
c.fonts.monospace = '"Roboto Mono for Powerline", "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
